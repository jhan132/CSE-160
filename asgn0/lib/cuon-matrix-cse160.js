...
class Vector3 {
    ...
    add(other) {
        var e = this.elements, f = other.elements;
    ...
    static dot(other1, other2) {
        var a = other1.elements, b = other2.elements;
...
class Matrix4 {
    ...
    set(src) {
        var i, s, d;
        s = src.elements; d = this.elements;
        if (s === d) { return; }
        for (i = 0; i < 16; ++i) { d[i] = s[i]; }
        return this;
    }
    ...
    multiplyVector3(pos) {
      var e=this.elements, p=pos.elements, v=new Vector3(), result=v.elements;
    ...
    multiplyVector4(pos) {
      var e=this.elements, p=pos.elements, v=new Vector4(), result=v.elements;
    ...
    setInverseOf(other) {
      var i, s, d, inv, det;
      s=other.elements; d=this.elements; inv=new Float32Array(16);
    ...
    setOrtho(left, right, bottom, top, near, far) {
      ...
      rw=1/(right-left); rh=1/(top-bottom); rd=1/(far-near);
      e=this.elements;
      e[0]=2*rw; e[1]=0; e[2]=0; e[3]=0;
      e[4]=0; e[5]=2*rh; e[6]=0; e[7]=0;
      e[8]=0; e[9]=0; e[10]=-2*rd; e[11]=0;
      e[12]=-(right+left)*rw; e[13]=-(top+bottom)*rh; e[14]=-(far+near)*rd; e[15]=1;
      return this;
    };
    ...
    setFrustum(left,right,bottom,top,near,far) {
      ...
      e[8]=(right+left)*rw; e[9]=(top+bottom)*rh; e[10]=-(far+near)*rd; e[11]=-1;
      e[12]=0; e[13]=0; e[14]=-2*near*far*rd; e[15]=0;
      return this;
    };

    frustum(left,right,bottom,top,near,far) { return this.concat(new Matrix4().setFrustum(left,right,bottom,top,near,far)); };
    ...
    setPerspective(fovy,aspect,near,far) {
      ...
      if (near<=0) { throw 'near <= 0'; }
      if (far<=0) { throw 'far <= 0'; }
      fovy=Math.PI*fovy/180/2; s=Math.sin(fovy);
      if (s===0) { throw 'null frustum'; }
      rd=1/(far-near); ct=Math.cos(fovy)/s;
      e=this.elements;
    ...
    setRotate(angle,x,y,z) {
      ...
      angle=Math.PI*angle/180; e=this.elements;
      ...
      if (0!==x&&0===y&&0===z) {
        ...
        nc=1-c; xy=x*y; yz=y*z; zx=z*x; xs=x*s; ys=y*s; zs=z*s;
    ...
    setLookAt(eyeX,eyeY,eyeZ,centerX,centerY,centerZ,upX,upY,upZ) {
      ...
      rlf=1/Math.sqrt(fx*fx+fy*fy+fz*fz); fx*=rlf; fy*=rlf; fz*=rlf;
      sx=fy*upZ-fz*upY; sy=fz*upX-fx*upZ; sz=fx*upY-fy*upX;
      rls=1/Math.sqrt(sx*sx+sy*sy+sz*sz); sx*=rls; sy*=rls; sz*=rls;
    ...
    dropShadow(plane,light) {
      var mat=new Matrix4(), e=mat.elements;
      var dot=plane[0]*light[0]+plane[1]*light[1]+plane[2]*light[2]+plane[3]*light[3];
      e[0]=dot-light[0]*plane[0]; e[1]=-light[1]*plane[0]; e[2]=-light[2]*plane[0]; e[3]=-light[3]*plane[0];
      e[4]=-light[0]*plane[1]; e[5]=dot-light[1]*plane[1]; e[6]=-light[2]*plane[1]; e[7]=-light[3]*plane[1];
      e[8]=-light[0]*plane[2]; e[9]=-light[1]*plane[2]; e[10]=dot-light[2]*plane[2]; e[11]=-light[3]*plane[2];
      e[12]=-light[0]*plane[3]; e[13]=-light[1]*plane[3]; e[14]=-light[2]*plane[3]; e[15]=dot-light[3]*plane[3];
